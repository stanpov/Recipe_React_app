                ...
                <div className="active-recipe">
                    ...
                    <div className="active-recipe-info">
                        ...
                        <div className="active-recipe-like-dislike">
                            ...
                            <button className="active-recipe__button__comment"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-chat-right-text" viewBox="0 0 16 16">
